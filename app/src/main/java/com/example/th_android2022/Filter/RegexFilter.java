...
public class RegexFilter {
    private final static Pattern PACKAGE_PATTERN_EN = Pattern.compile("package|delivery|deliver|delivered|track|tracking|ship|shipping|arrive|arriving|order|dispatched", Pattern.CASE_INSENSITIVE);
